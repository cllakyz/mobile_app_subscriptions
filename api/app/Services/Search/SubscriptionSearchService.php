...
class SubscriptionSearchService
{
    ...
    public function bulkIndex($subscriptions)
    {
        ...
        return $this->elasticsearchService->bulkIndex('subscriptions', $body);
    }

    public function index(Subscription $subscription)
    {
        $esData = $this->getIndexBody($subscription);
        return $this->elasticsearchService->indexDocument('subscriptions', $esData);
    }
    ...
    public function search($params = [])
    {
        ...
        $docs = $this->elasticsearchService->search('subscriptions', $body);
